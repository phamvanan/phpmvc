  ...
  <div class="panel">
    ...
    <div class="panel-body">
      <div class="row">
        <div class="col-md-6">
          <div class="mb-15">
            <a href="?controller=product&action=formthem" class="btn btn-outline btn-primary" type="button">
          ...
          ?>
            <tr class="gradeA">
              ...
              <td class="actions">
                ...
                <a href="?controller=product&action=updateform&id=<?= $value->id ?>" class="btn btn-sm btn-icon btn-pure btn-default on-default" data-toggle="tooltip" data-original-title="Edit"><i class="icon wb-edit" aria-hidden="true"></i></a>
            ...
            <div class="modal-dialog modal-simple modal-center">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" data-controller="product" data-action="xoaproduct" id="btnXoa" class="btn btn-danger">Xóa</button>
                </div>
              </div>
            </div>
          </div>
